...
public class ResourceServiceTests {
  ...
  void isInUseOnDate_matchingDates_returnsTrue() {
    assertTrue(
        resourceService.anyInUseOnDate(
            TestData.dateNow, TestData.ResourcesInUse.allResourcesInUse));
  }
  ...
  void isInUseOnDate_nonMatchingDates_returnsFalse() {
    assertFalse(
        resourceService.anyInUseOnDate(
            TestData.dateNeverUsed, TestData.ResourcesInUse.allResourcesInUse));
  }
